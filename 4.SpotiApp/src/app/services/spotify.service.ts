...
export class SpotifyService {
  ...
  private urlBusqueda: string = "https://afmerjfupi.spotify.com/v1/search";
  private urlArtista: string = "https://apfmerjfui.spotify.com/v1/artists";

  private urlLogin: string = "https://localhost:9443/miudelar-server/security/generatePassword/input/dgsg";
  ...
  getToken() {
    ...
    headers.append('Access-Control-Allow-Methods', 'PUT, GET, POST, DELETE, OPTIONS, HEAD');
    headers.append('Access-Control-Max-Age', '1209600');
   // headers.append('preflightContinue', 'false');
