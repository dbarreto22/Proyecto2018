...
export class ApiService {
 ...
 API_URL = 'http://0bdc6f27.ngrok.io/miudelar-server';
  ...
  getCursosByCedula(): Observable<Array<cursos>> {
    return this.httpClient.get<Array<cursos>>(`${this.API_URL}/estudiante/cursoAng/` + this.cedula);
  }
  ...
  getExamenByCedula(): Observable<Array<examenes>> {
    return this.httpClient.get<Array<examenes>>(`${this.API_URL}/estudiante/examenAng/` + this.cedula);
  }
